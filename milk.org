...
**** Root Dir Of Milk
#+BEGIN_SRC emacs-lisp
  (defvar milk-dir (file-name-directory load-file-name))
  ;(defvar milk-dir "~/.emacs.d")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (milk-require-packages '(monokai-theme
                           gruvbox-theme
                           seti-theme
                           org-bullets
...
**** Set Distel Hook
#+BEGIN_SRC emacs-lisp
  (when (and (file-exists-p (expand-file-name "distel" milk-vendor-dir))
             (file-exists-p (expand-file-name "company-distel" milk-vendor-dir)))
...
**** Mine ESC ESC SPC
#+BEGIN_SRC emacs-lisp
  (global-set-key (kbd "\e M-SPC c") 'current-weather)
  (global-set-key (kbd "\e M-SPC f") 'forecast-weather)
  (global-set-key (kbd "\e M-SPC s") 'magit-status)
  (global-set-key (kbd "\e M-SPC l") 'magit-log-buffer-file)
  (global-set-key (kbd "\e M-SPC b") 'milk-toggle-magit-blame)
#+END_SRC
*** Define
**** Ibuffer Occur
#+BEGIN_SRC emacs-lisp
